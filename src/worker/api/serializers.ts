import type { AuditEntry, Campaign, Domain, Link, Passkey, User } from "../../db/schema.ts";
import type { AuditEntryDto, CampaignDto, DomainDto, LinkDto, PasskeyDto, UserDto } from "../../shared/contract.ts";
